  ...
  >
        ...
        >
          <span class="nav-icon py-2 w-auto">
            <span class="svg-icon svg-icon-3x">
              ...
              <inline-svg :src="resolveSvgPath('media/svg/icons/Home/Library.svg')" />
              <!--end::Svg Icon-->
            </span>
          </span>
        ...
        >
          <span class="nav-icon py-2 w-auto">
            <span class="svg-icon svg-icon-3x">
              ...
              <inline-svg :src="resolveSvgPath('media/svg/icons/Layout/Layout-4-blocks.svg')" />
              <!--end::Svg Icon-->
            </span>
          </span>
          <span
    ...
    <div class="tab-content m-0 p-0">
      <div
        ...
        role="tabpanel"
      ></div>
      <div class="tab-pane" id="forms_widget_tab_2" role="tabpanel">1</div>
      <div class="tab-pane" id="forms_widget_tab_3" role="tabpanel">2</div>
      <div class="tab-pane" id="forms_widget_tab_4" role="tabpanel">3</div>
      <div class="tab-pane" id="forms_widget_tab_6" role="tabpanel">4</div>
    </div>
    <!--end::Nav Content-->
  </div>
</template>
...
export default {
  ...
  methods : {
    resolveSvgPath(icon){
      return process.env.BASE_URL + icon;
    }
  },
  data() {
    return {
